                                        ...
                                        {currentClass.students.map((student) => (
                                            <TableRow key={student.id} className="border-b border-gray-100 hover:bg-gray-50/80 transition-colors">
                                                ...
                                                <TableCell className="px-6 py-4 text-right">
                                                    <Button 
                                                        variant="ghost"
                                                        className="inline-flex items-center gap-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 text-[13px] font-semibold transition-colors rounded-full"
                                                        onClick={() => router.push(`/holistic-report/${student.id}`)}
                                                    >
